...
var RedisPubSub = (function () {
    ...
    RedisPubSub.prototype.subscribe = function (trigger, onMessage, options) {
        ...
        if (refs && refs.length > 0) {
            this.subsRefsMap[triggerName] = __spreadArray(__spreadArray([], refs, true), [id], false);
            ...
            return new Promise(function (resolve, reject) {
                ...
                subscribeFn.call(_this.redisSubscriber, triggerName, function (err) {
                    if (err) {
                        ...
                        _this.subsRefsMap[triggerName] = __spreadArray(__spreadArray([], (_this.subsRefsMap[triggerName] || []), true), [
                            id,
                        ], false);
                        resolve(id);
                    }
    ...
    RedisPubSub.prototype.unsubscribe = function (subId) {
        ...
        if (refs.length === 1) {
            ...
            this.subsRefsMap[triggerName] = index === -1
                ? refs
                : __spreadArray(__spreadArray([], refs.slice(0, index), true), refs.slice(index + 1), true);
        }
    ...
    RedisPubSub.prototype.onMessage = function (pattern, channel, message) {
        return __awaiter(this, void 0, void 0, function () {
            var subscribers, parsedMessage, _a, e_1, _i, subscribers_1, subId, _b, listener;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        subscribers = this.subsRefsMap[pattern || channel];
                    ...
                    case 1:
                        _c.trys.push([1, 5, , 6]);
                        if (!this.deserializer) return [3, 3];
                        return [4, this.deserializer(message, { pattern: pattern, channel: channel })];
                    case 2:
                        _a = _c.sent();
                        return [3, 4];
                    case 3:
                        _a = JSON.parse(message, this.reviver);
                        _c.label = 4;
                    case 4:
                        parsedMessage = _a;
                        return [3, 6];
                    ...
                    case 6:
                        for (_i = 0, subscribers_1 = subscribers; _i < subscribers_1.length; _i++) {
                            subId = subscribers_1[_i];
                            _b = this.subscriptionMap[subId], listener = _b[1];
